...
console.log("🔧 Updating Domestic-customer-identification prompt to latest version...");
...
async function updateDomesticCustomerIdentificationPrompt() {
  try {
    console.log("🔧 Updating Domestic-customer-identification prompt in Langfuse...");
    ...
    console.log("✅ Domestic-customer-identification prompt updated successfully!");
    console.log("Prompt ID:", result.id);
    console.log("Prompt version:", result.version);
    
  } catch (error) {
    console.error("❌ Error updating Domestic-customer-identification prompt:", error);
    if (error.response) {
...
updateDomesticCustomerIdentificationPrompt();
