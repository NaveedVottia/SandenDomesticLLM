...
async function searchProducts(sessionId, query, category) {
    try {
        ...
        const filtered = rows.filter((r) => JSON.stringify(r).includes(query));
...
async function zapierCall(event, payload) {
